...
<head>
    ...
    <title>Chỉnh sửa hội viên - Hệ thống Gym</title>
...
<body>
    ...
    <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2><i class="fas fa-user-edit me-2" style="color:#ff7a00"></i>Chỉnh sửa hội viên</h2>
                ...
                <form method="POST" action="${pageContext.request.contextPath}/members">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-3">
                        ...
                        <button type="submit" class="btn btn-danger">
                            <i class="fas fa-save me-1"></i>Cập nhật hội viên
                        </button>
                    </div>
                </form>
            </div>
